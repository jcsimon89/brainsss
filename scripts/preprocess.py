...
def main(args):
    modules = 'gcc/6.3.0 python/3.6 py-numpy/1.14.3_py36 py-pandas/0.23.0_py36 viz py-scikit-learn/0.19.1_py36 antspy/0.3.2'
    ...
    if correlation:
        ...
        for func in funcs:
            ...
            if use_warp:
                ...
                brain_file = 'functional_channel_1_moco_zscore_highpass.h5'
                fps = 100
